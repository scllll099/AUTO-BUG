...
local Themes = {
	...
	SpeedHubX = nil, -- alias resolved below
	NovaHub = {
		Name = "NovaHub",
...
-- Alias so fallback works
Themes.SpeedHubX = Themes.NovaHub
...
function Creator.GetThemeProperty(Property)
	...
	return Themes["NovaHub"][Property]
end
...
Components.Window = (function()
	...
	return function(Config)
		...
		local PlayerThumb = New("ImageLabel", {
			Size = UDim2.fromScale(1, 1),
			BackgroundTransparency = 1,
		...
		local SidebarBg = New("Frame", {
			Size = UDim2.new(0, Window.TabWidth + 24, 1, -42),
		...
		local SidebarLine = New("Frame", {
			...
			Position = UDim2.new(0, Window.TabWidth + 23, 0, 42),
			ThemeTag = { BackgroundColor3 = "TitleBarLine" },
			BackgroundTransparency = 0.5,
		})

		local TabFrame = New("Frame", {
			Size = UDim2.new(0, Window.TabWidth, 1, -130),
...
function Library:CreateWindow(Config)
	...
	if not Config.Size then
		Config.Size = UDim2.fromOffset(580, 440)
	end
	-- Default tab width
	if not Config.TabWidth then
		Config.TabWidth = 148
	end
	...
	Library.Theme = Config.Theme or "NovaHub"
